/*! dockerui - v0.6.0 - 2015-06-20
 * https://github.com/crosbymichael/dockerui
 * Copyright (c) 2015 Michael Crosby & Kevan Ahlquist;
 * Licensed MIT
 */
angular.module('dockerui', ['dockerui.templates', 'ngRoute', 'dockerui.services', 'dockerui.filters', 'masthead', 'footer', 'dashboard', 'container', 'containers', 'containersNetwork', 'images', 'image', 'startContainer', 'sidebar', 'info', 'builder', 'containerLogs', 'containerTop', 'containerStats', 'events'])
	...
	$routeProvider.when('/containers/:id/containerstats', {
...
.controller('ContainerController', ['$scope', '$routeParams', '$location', 'Container', 'ContainerCommit', 'ContainerStats', 'Messages', 'ViewSpinner',
function($scope, $routeParams, $location, Container, ContainerCommit, ContainerStats, Messages, ViewSpinner) {
    $scope.changes = [];
    $scope.edit = false;
   ...
   $scope.stats =  function() {
        ViewSpinner.spin();
        ContainerStats.stats({id: $routeParams.id}, function(d) {
            getstats();
            Messages.send("Container Stats", $routeParams.id);
        }, function(e) {
            update();
            Messages.error("Failure", "failed to retrieve stats." + e.data);
        });
    };
...
angular.module('dockerui.services', ['ngResource'])
	...
	.factory('ContainerStats', function ($http, Settings) {
        'use strict';
        return {
            get: function (id, params, callback, errorCallback) {
                $http({
                    method: 'GET',
                    url: Settings.url + '/containers/' + id + '/stats',
			params: {
                        'stream': 0
                    }
                }).success(callback);
...
angular.module('dockerui.templates', ['app/components/builder/builder.html', 'app/components/container/container.html', 'app/components/containerLogs/containerlogs.html', 'app/components/containerStats/containerstats.html', 'app/components/containerTop/containerTop.html', 'app/components/containers/containers.html', 'app/components/containersNetwork/containersNetwork.html', 'app/components/dashboard/dashboard.html', 'app/components/events/events.html', 'app/components/footer/statusbar.html', 'app/components/image/image.html', 'app/components/images/images.html', 'app/components/info/info.html', 'app/components/masthead/masthead.html', 'app/components/sidebar/sidebar.html', 'app/components/startContainer/startcontainer.html']);
...
angular.module("app/components/container/container.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/container/container.html",
    ...
    "        <tr>\n" +
    "            <td>Stats:</td>\n" +
    "            <td><a href=\"#/containers/{{ container.Id }}/containerstats\">Stats</a></td>\n" +
    "        </tr>\n" +
    "        <tr>\n" +
    "            <td>Top:</td>\n" +
...
angular.module("app/components/containerStats/containerstats.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("app/components/containerStats/containerstats.html",
    "<div class=\"row containerstats\">\n" +
    "    <div class=\"col-xs-12\">\n" +
    "<h4>Stats for container</h4> \n" +
    "                <canvas id=\"containers-stats-chart\" height=\"300\" width=\"600\">\n" +
    "                    <p class=\"browserupgrade\">You are using an <strong>outdated</strong> browser. Please <a href=\"http://browsehappy.com/\">upgrade your browser</a> to improve your experience.</p>\n" +
    "                </canvas>\n" +
    "                <div id=\"chart-stats-legend\"></div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "");
}]);
